...
export const RecommendationCard = ({ recommendation }: RecommendationCardProps) => (
  <article className="rounded-md border border-slate-200 bg-white p-5 shadow-sm" id={recommendation.id}>
    ...
    <h2 className="mt-4 text-2xl font-semibold tracking-tight text-slate-950">{recommendation.title}</h2>
    <section className="mt-5">
      <h3 className="text-sm font-semibold uppercase tracking-[0.14em] text-slate-500">Diagnostico</h3>
      <p className="mt-2 text-sm leading-6 text-slate-700">{recommendation.diagnosis}</p>
    </section>
    <section className="mt-5">
      <h3 className="text-sm font-semibold uppercase tracking-[0.14em] text-slate-500">Procedimento</h3>
      <ol className="mt-3 space-y-2">
        {recommendation.procedure.map((step) => (
    ...
    <section className="mt-5 rounded-md border border-slate-200 bg-slate-50 p-4">
      ...
      <p className="mt-2 text-sm leading-6 text-slate-800">{recommendation.suggestedScript}</p>
    </section>
    <section className="mt-5">
    ...
    <section className="mt-5 border-t border-slate-200 pt-5">
      ...
      <p className="mt-2 text-sm leading-6 text-slate-700">{recommendation.correctiveAction}</p>
    </section>
  </article>
);
